package co.develhope.springdevelhope.interceptors;

import co.develhope.springdevelhope.entities.Month;
...
public class MonthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        String monthNumberString = request.getHeader("Month-Number");
        if(monthNumberString == null || monthNumberString.isEmpty()){
            ...
            }else {request.setAttribute("MonthInterceptor-month",
                    new Month(0,"null","null","null"));}
